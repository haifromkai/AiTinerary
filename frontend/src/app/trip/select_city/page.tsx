...
export default function NameTrip() {
  ...
  return (
    <div className="relative flex flex-col items-center justify-center min-h-screen bg-white p-2 custom-grid-bg">
      ...
      <h1 className="text-4xl md:text-6xl font-mono text-[rgb(49,49,49)] mt-2 md:mt-2 text-center">Select City</h1>
      

      {/* Page Content */}
      <div className="w-full max-w-md my-8">
        {/* Text Input Box with Google Places API Integration for Autocomplete*/}
        <input 
          type="text" 
          placeholder="Enter a city name (implement Google Places APIautocomplete)" 
